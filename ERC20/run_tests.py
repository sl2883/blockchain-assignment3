...
class TestERC20Challenge(unittest.TestCase):
    ...
    def test_deposit(self):
        ...
        print("self.eth_tester.get_balance(self.account1) ", self.eth_tester.get_balance(self.account1))
        print("initial_a1_balance ", initial_a1_balance)
        print("deposit_tx_receipt['gasUsed'] ", deposit_tx_receipt['gasUsed'])
        print("withdraw_tx_receipt['gasUsed'] ", withdraw_tx_receipt['gasUsed'])
